          ...
          {!bookOpened ? (
            ...
            >
              ...
              <div className={`book-spread ${isFlipping ? `flipping-${flipDirection}` : ''}`} style={{ position: 'relative' }}>
                ...
                {canGoPrevious() && bookOpened && (
                  <button
                    onClick={goToPreviousPage}
                    disabled={isFlipping}
                    className={`absolute left-[-80px] top-1/2 -translate-y-1/2 p-4 rounded-full shadow-lg transition-all hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed z-10 ${
                ...
                {canGoNext() && bookOpened && (
                  <button
                    onClick={goToNextPage}
                    disabled={isFlipping}
                    className={`absolute right-[-80px] top-1/2 -translate-y-1/2 p-4 rounded-full shadow-lg transition-all hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed z-10 ${
                      isDarkMode ? 'bg-gray-800 text-white hover:bg-gray-700' : 'bg-white text-gray-800 hover:bg-gray-50'
                    }`}
                    style={{ filter: 'none', WebkitFilter: 'none' }}
                    title="Next Page"
