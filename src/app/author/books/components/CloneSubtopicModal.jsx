// components/CloneSubtopicModal.jsx
export default function CloneSubtopicModal({
  show,
  loading,
  allBooks,
  currentBookId,
            ...
            {availableTopicsForSubtopic.length > 0 && (
              <div>
                ...
                <select
                  ...
                  onChange={(e) => onSourceTopicChange(e.target.value)}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-black"
                >
                  ...
                  {availableSubtopics.map(subtopic => (
                    <label key={subtopic.id} className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-2 rounded">
                      <input
                        ...
                        onChange={() => onSubtopicSelection(subtopic.id)}
                  ...
                  {selectedSubtopics.map((subtopicId, idx) => (
                    <div key={subtopicId}>
                      ...
                      <input
                        ...
                        onChange={(e) => onSubtopicTitleChange(subtopicId, e.target.value)}
